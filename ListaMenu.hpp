...
public:
    ListaMenu() : cabeza(nullptr), cola(nullptr), tama�o(0) {}

    ListaMenu(const ListaMenu<T>& otra) : cabeza(nullptr), cola(nullptr), tama�o(0) {
    ...
    bool eliminarEnPosicion(int posicion) {
        ...
        if (posicion < tama�o / 2) {
            ...
            actual = cola;
            for (int i = tama�o - 1; i > posicion; i--) {
    ...
    int getTama�o() const { return tama�o; }
