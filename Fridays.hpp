...
public:
    ...
    void modoAdministrador() {
        ...
        do {
            ...
            case 4:
                limpiarPantalla();
                // Aquí puedes mostrar la información del restaurante
                cout << ROJO << "INFORMACION DEL RESTAURANTE" << endl;
                imprimirSeparadorRojoBlanco(20);
                cout << "Nombre: " << nombreRestaurante << endl;
    ...
    void menuGestionMenu() {
        ...
        do {
            ...
            case 5: {  // BUSCAR PRODUCTO
                ...
                case 2: {  // Buscar por nombre exacto
                    string nombre;
